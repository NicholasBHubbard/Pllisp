...
externDecls = T.unlines
  ...
  , "declare double @pll_test_apply_flt64(ptr, double)"
  , "declare float @pll_test_apply_flt32(ptr, float)"
  , "declare double @pll_test_apply_mix_num(ptr, i64, double)"
...
llvmType Ty.TySyntax = error "Codegen BUG: SYNTAX reached runtime codegen"
